...
* Deploy your node on any cloud provider with a static IP to make it accessible
  ...
  - If you want to customize which domains your frontend is allowed to connect to
    you must copy the [Caddyfile from frontend](https://github.com/deso-protocol/frontend/blob/main/Caddyfile) into this directory and set the `CADDY_FILE`
    variable in [dev.env](https://github.com/deso-protocol/run/blob/main/dev.env).
